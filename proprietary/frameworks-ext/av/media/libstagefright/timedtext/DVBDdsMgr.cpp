    ...
    UINT16              ui2_page_id)
{
    ...
    if (NULL==pt_dds)
    {
        ...
        /*create a new dds*/
        i4_ret = sm_sbtl_dds_create(pt_this->pt_service,
                                    pui1_data,
                                    ui4_data_len,
                                    ui2_page_id,
                                    &pt_dds);
    ...
    else
    {
        ...
        i4_ret = sm_sbtl_dds_parse_segment(pt_dds,
                                           pt_this->pt_service,
                                           pui1_data,
                                           ui4_data_len);
    }
    ...
    UINT16              ui2_page_id)
{
    ...
    {
        i4_ret = sm_sbtl_service_update_logi_size(pt_this->pt_service, 720, 576);
    }
 ...
 * Returns: -
 ----------------------------------------------------------------------------*/
static DvbDds* DvbDdsMgr::getDds(
    UINT16              ui2_page_id)
{
    INT32           i;
    DvbDds*  pt_dds;
 ...
 * Returns: -
 ----------------------------------------------------------------------------*/
static INT32 DvbDdsMgr::insertDds(
    DvbDds*      pt_dds)
{
    DvbDds** apt_dds_lst;
    ...
    if (this->ui1_dds_lst_cnt==this->ui1_dds_lst_size)
    {
        ...
        free(this->pt_service, (VOID*)this->apt_dds_lst);
