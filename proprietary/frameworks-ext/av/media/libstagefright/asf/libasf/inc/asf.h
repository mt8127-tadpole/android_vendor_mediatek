...
#define FOURCC_DX60		MAKEFOURCC('D','X','6','0')
...
#define FOURCC_S263     MAKEFOURCC('S','2','6','3')
//MPEG1
#define FOURCC_MPG1		MAKEFOURCC('M','P','G','1')
//MPEG2
#define FOURCC_MPEG		MAKEFOURCC('M','P','E','G')
#define FOURCC_MPG2		MAKEFOURCC('M','P','G','2')
#define FOURCC_MPGV		MAKEFOURCC('M','P','G','V')
