...
static void muteAmplifier(Tfa9887_handle_t handle)
{
    ...
    {
        ALOGD("muteAmplifier read TFA9887_STATUSREG");
        err = Tfa9887_ReadRegister16(handle, TFA9887_STATUSREG, &status);
        assert(err == Tfa9887_Error_Ok);
    }
}
...
static Tfa9887_handle_t handle;
...
int StartUpNxpSpeaker(unsigned int SampleRate)
{
    ...
    Tfa9887_SelectAmplifierInput(handle, Tfa9887_AmpInputSel_I2SLeft);
...
{
    Tfa9887_Error_t err;
    unsigned short i2s_sel_value;

    ALOGE("+MtkTfa98xxBypassOn");
    ...
    /*
        ...
        assert(err == Tfa9887_Error_Ok);
    */
    err = Tfa9887_ReadRegister16(handle, TFA9887_I2S_SEL_REG, &i2s_sel_value);
    assert(err == Tfa9887_Error_Ok);
    printf("[wj]sys value read = 0x%04x\n", i2s_sel_value);
    i2s_sel_value  = i2s_sel_value | 0x2;
    printf("[wj]sys value will write = 0x%04x\n", i2s_sel_value);
    err = Tfa9887_WriteRegister16(handle, TFA9887_I2S_SEL_REG, i2s_sel_value); /* CIMTP=1 */
    assert(err == Tfa9887_Error_Ok);
