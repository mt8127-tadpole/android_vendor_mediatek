...
//hack define KPOC LOG as kernel printk default is not 7
//and keep full log in Android logcat
#define KPOC_LOG_LEVEL 1
#define KPOC_LOGE(x...) (KPOC_LOG_LEVEL <= 3 ? KLOG_ERROR(LOG_TAG, x): ALOGE(x)) //level 1
#define KPOC_LOGI(x...) (KPOC_LOG_LEVEL <= 2 ? KLOG_ERROR(LOG_TAG, x): ALOGI(x)) //level 2
#define KPOC_LOGD(x...) (KPOC_LOG_LEVEL <= 1 ? KLOG_ERROR(LOG_TAG, x): ALOGD(x)) //level 3
#endif

#define ARRAY_SIZE(a) (sizeof (a) / sizeof ((a)[0]))
//#define VBAT_POWER_ON_DEFAULT  3450000
//#define VBAT_POWER_OFF_DEFAULT 3400000
...
#define ONLY_SHOW_CHARGING_LOGO
/* ignore case */
