...
void MtkAudioLoud::copyParam(void)
{
    ...
    mInitParam.pMode_Param->pCustom_Param->DRC_Delay = mAudioParam.bes_loudness_DRC_Delay;
    mInitParam.pMode_Param->pCustom_Param->Lim_Th = mAudioParam.bes_loudness_Lim_Th;
    mInitParam.pMode_Param->pCustom_Param->Lim_Gn = mAudioParam.bes_loudness_Lim_Gn;
    mInitParam.pMode_Param->pCustom_Param->Lim_Const = mAudioParam.bes_loudness_Lim_Const;
    mInitParam.pMode_Param->pCustom_Param->Lim_Delay = mAudioParam.bes_loudness_Lim_Delay;
    mInitParam.pMode_Param->pCustom_Param->Sep_LR_Filter = mIsSepLR_Filter = mAudioParam.bes_loudness_Sep_LR_Filter;
    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->Att_Time, (void *)mAudioParam.bes_loudness_Att_Time, 48 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->Rel_Time, (void *)mAudioParam.bes_loudness_Rel_Time, 48 * sizeof(unsigned int));
    ...
    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->SB_Mode, (void *)mAudioParam.bes_loudness_SB_Mode, 8 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->Hyst_Th, (void *)mAudioParam.bes_loudness_Hyst_Th, 48 * sizeof(int));
    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_L->HPF_COEF, (void *)mAudioParam.bes_loudness_hsf_coeff_L, 90 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_L->BPF_COEF, (void *)mAudioParam.bes_loudness_bpf_coeff_L, 144 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_L->LPF_COEF, (void *)mAudioParam.bes_loudness_lpf_coeff_L, 18 * sizeof(unsigned int));

    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_R->HPF_COEF, (void *)mAudioParam.bes_loudness_hsf_coeff_R, 90 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_R->BPF_COEF, (void *)mAudioParam.bes_loudness_bpf_coeff_R, 144 * sizeof(unsigned int));
    memcpy((void *)mInitParam.pMode_Param->pFilter_Coef_R->LPF_COEF, (void *)mAudioParam.bes_loudness_lpf_coeff_R, 18 * sizeof(unsigned int));

    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->DRC_Th, (void *)mAudioParam.bes_loudness_DRC_Th, 40 * sizeof(int));
    memcpy((void *)mInitParam.pMode_Param->pCustom_Param->DRC_Gn, (void *)mAudioParam.bes_loudness_DRC_Gn, 40 * sizeof(int));
    ...
    if (mIsSepLR_Filter == 0)
    {
        ...
        memset((void*)mInitParam.pMode_Param->pFilter_Coef_R->BPF_COEF, 0, 24*sizeof(unsigned int));
