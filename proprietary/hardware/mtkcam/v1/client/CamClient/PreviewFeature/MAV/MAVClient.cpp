...
init(int bufwidth,int bufheight)
{
    ...
    // (3) initial algorithm
    err = mpMAVObj->mHal3dfInit((void*)mpMAVWorkingBuf->getBufVA(0), (void*)mpMotionBuffer->getBufVA(0), (void*)mpWarpBuffer->getBufVA(0), (void*)mpMAVMotionBuffer->getBufVA(0));
    if ( err < 0 ) {
...
mHalCamFeatureMerge()
{
    ...
    for (MUINT8 i = 0; i < MAVnum; i++)
    {
        ...
        savedataToFile((char *) sourceFiles, (MUINT8 *)(mpframeBuffer[i]->getBufVA(0)), mMAVFrameSize);
    }
#endif
    return err;
}
