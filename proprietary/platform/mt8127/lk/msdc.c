	...
	switch(host->id){
		case 0:
            switch (mode) {
                case MSDC0_PULL_NONE:
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
                    
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
                    break;
                case MSDC0_PU_10K:
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 1);
                    MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 0);
                    
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0);
                   
					MSDC_SET_FIELD(MSDC0_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					MSDC_SET_FIELD(MSDC0_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    MSDC_SET_FIELD(MSDC0_GPIO_CLK_BASE, GPIO_MSDC0_CLK_PUPD_MASK, 1);
                    break;
                case MSDC0_PU_50K:
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 0);
                    
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0);
                    break;
                case MSDC0_PU_8K:
                ...
                case MSDC0_PD_10K:
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 1);
                    MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 1);
                    
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0x1111);
                    break;
                case MSDC0_PD_50K:
					MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
		...
		case 1:
            if (MSDC1_PU_50K == mode){
					MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 0);
                    
					MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0);

					MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_CLK_PUPD_MASK, 1);
            } else if (MSDC1_PD_50K == mode){
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 1);

				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0x1111);
				...
				//set to H-Z
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
				MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 0);

				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
				MSDC_SET_FIELD(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0);

				MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 0);
				MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_CLK_PUPD_MASK, 0);
		...
		case 2:
            if (MSDC2_PU_50K == mode){
					MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 0);
                    
					MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					MSDC_SET_FIELD(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0);

					MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC2_CLK_PUPD_MASK, 1);

            } else if (MSDC2_PD_50K == mode){
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 1);

				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0x1111);
				...
				//set to H-Z
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
				MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 0);

				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
				MSDC_SET_FIELD(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0);

				MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
				MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 0);
				MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_MSDC2_CLK_PUPD_MASK, 0);
...
void msdc_set_smt(struct mmc_host *host,int set_smt)
{
    switch(host->id){
        case 0:
			MSDC_SET_FIELD(MSDC0_GPIO_CLK_BASE, GPIO_MSDC0_CLK_SMT_MASK, set_smt);
			MSDC_SET_FIELD(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_SMT_MASK, set_smt);
			MSDC_SET_FIELD(MDSC0_DAT_PAD_1, GPIO_MSDC0_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
			MSDC_SET_FIELD(MDSC0_DAT_PAD_2, GPIO_MSDC0_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
            break;
        case 1:
            MSDC_SET_FIELD(MSDC1_GPIO_CLK_BASE, GPIO_SMT_MASK, set_smt);
            MSDC_SET_FIELD(MSDC1_GPIO_CMD_BASE, GPIO_SMT_MASK, set_smt);
			MSDC_SET_FIELD(MDSC1_DAT_PAD_1, GPIO_MSDC1_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
            break;
        case 2:
			MSDC_SET_FIELD(MSDC2_GPIO_CLK_BASE, GPIO_SMT_MASK, set_smt);
			MSDC_SET_FIELD(MSDC2_GPIO_CMD_BASE, GPIO_SMT_MASK, set_smt);
			MSDC_SET_FIELD(MDSC2_DAT_PAD_1, GPIO_MSDC2_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
			break;
		default:
			break;
	}
...
int msdc_init(struct mmc_host *host, int id)
{
	...
	MSDC_WRITE32(MSDC_PATCH_BIT1, 0xFFFF00C9);//High 16 bit = 0 mean Power KPI is on, enbale msdc ECO for write timeout issue
   ...
   // msdc_intr_unmask(host, 0x0001FF7B);
	...
	//Chaotian.Jing, must set below for SD card, or cannot recevice msdc interrupt
