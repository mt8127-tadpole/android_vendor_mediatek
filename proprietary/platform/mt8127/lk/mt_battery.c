...
#define BATTERY_LOWVOL_THRESOLD             3500 //Barkly, based on E/E feedback
...
extern void bq24196_turn_on_charging(kal_bool bEnable);
...
{    
	...
	if(0 == val)
#if defined(MTK_BQ24296_SUPPORT) || defined(MTK_BQ24196_SUPPORT)
...
#ifdef MTK_BQ24296_SUPPORT
    bq24296_hw_init();
    bq24296_turn_on_charging(KAL_FALSE);
    bq24296_dump_register();
#endif

#ifdef MTK_BQ24196_SUPPORT
    bq24196_hw_init();
    bq24196_turn_on_charging(KAL_FALSE);
