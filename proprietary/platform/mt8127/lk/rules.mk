...
OBJS += \
  ...
  $(LOCAL_DIR)/mt_get_dl_info.o \
	...
	$(LOCAL_DIR)/mtk_boot_share_page.o\
...
ifeq ($(MTK_ALPS_BOX_SUPPORT),yes)
  OBJS += $(LOCAL_DIR)/hdmi_drv.o
  DEFINES += MTK_ALPS_BOX_SUPPORT
endif
...
ifeq ($(MTK_ALPS_BOX_SUPPORT),yes)
ifeq ($(MTK_APLS_LK_IRRX_SUPPORT),yes)
 
   INCLUDES += -I../../../$(MTK_PATH_PLATFORM)/kernel/drivers/ir  
   CFLAGS += -DMTK_LK_IRRX_SUPPORT
   OBJS +=$(LOCAL_DIR)/mtk_ir_decode.o
   OBJS +=$(LOCAL_DIR)/mtk_ir_lk_core.o   
endif
endif
