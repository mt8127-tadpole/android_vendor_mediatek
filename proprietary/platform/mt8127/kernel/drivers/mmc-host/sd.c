...
{	
	...
	switch(id){
		case 0:
			sdr_get_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, tmp);
			reg |= tmp << 24;
			sdr_get_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, tmp);
			reg |= tmp << 20;
			...
			break;
		case 1:
			sdr_get_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, tmp);
			reg |= tmp << 24;
			sdr_get_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, tmp);
			reg |= tmp << 20;
			...
			break;
		case 2:
			sdr_get_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, tmp);
			reg |= tmp << 24;
			sdr_get_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, tmp);
			reg |= tmp << 20;
...
void msdc_set_rdtdsel_dbg(struct msdc_host *host,bool rdsel,u32 value)
{
	...
	switch(host->id){
		case 0:
			sdr_set_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, value);
			break;
		case 1:
            sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, value);
			break;
		case 2:
            sdr_set_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, value);
			break;
		default:
			break;
		}
		...
		switch(host->id){
		case 0:
			sdr_set_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, value);
			break;
		case 1:
            sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, value);
			break;
		case 2:
            sdr_set_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, value);
			break;
		default:
			break;
		}
...
void msdc_set_rdtdsel(struct msdc_host *host,bool sd_18)
{
	...
	switch(host->id){
		case 0:
			sdr_set_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, 0x0);
			sdr_set_field(MDSC0_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, 0x0A);
			break;
		case 1:
			if(sd_18){
				sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, 0x0C);
				sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, 0x0A);
			}
			else{
				sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, 0x0C);
				sdr_set_field(MDSC1_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, 0x0A);
			...
			break;
		case 2:
			sdr_set_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_RDSEL_MASK, 0x0);
			sdr_set_field(MDSC2_DAT_PAD_TD_RDSEL, GPIO_PAD_TDSEL_MASK, 0x0);
			break;
		default:
			break;
	}
	...
	switch(host->id){
		case 0:
            switch (mode) {
                case MSDC0_PULL_NONE:
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
                    
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
                    break;
                case MSDC0_PU_10K:
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 1);
                    sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 0);
                    
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0);
                   
					sdr_set_field(MSDC0_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					sdr_set_field(MSDC0_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    sdr_set_field(MSDC0_GPIO_CLK_BASE, GPIO_MSDC0_CLK_PUPD_MASK, 1);
                    break;
                case MSDC0_PU_50K:
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 0);
                    
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0);
                    break;
                case MSDC0_PU_8K:
                ...
                case MSDC0_PD_10K:
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 1);
                    sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_PUPD_MASK, 1);
                    
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R0_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC_DAT_R1_MASK, 0);
					sdr_set_field(MDSC0_DAT_PAD_1, MSDC0_DAT_PAD_PUPD_MASK, 0x1111);
					sdr_set_field(MDSC0_DAT_PAD_2, MSDC0_DAT_PAD_PUPD_MASK, 0x1111);
                    break;
                case MSDC0_PD_50K:
					sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
		...
		case 1:
            if (MSDC1_PU_50K == mode){
					sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 0);
                    
					sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					sdr_set_field(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0);

					sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_CLK_PUPD_MASK, 1);
            } else if (MSDC1_PD_50K == mode){
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 1);

				sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
				sdr_set_field(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0x1111);
				...
				//set to H-Z
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_CMD_PUPD_MASK, 0);

				sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
				sdr_set_field(MDSC1_DAT_PAD_1, MSDC1_DAT_PAD_PUPD_MASK, 0);

				sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
				sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 0);
				sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_CLK_PUPD_MASK, 0);
		...
		case 2:
            if (MSDC2_PU_50K == mode){
					sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
                    sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
					sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 0);
                    
					sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
					sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
					sdr_set_field(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0);

					sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
					sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 1);
                    sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC2_CLK_PUPD_MASK, 1);

            } else if (MSDC2_PD_50K == mode){
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 1);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 1);

				sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0x1111);
				sdr_set_field(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0x1111);
				...
				//set to H-Z
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R0_MASK, 0);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC_CMD_R1_MASK, 0);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC2_CMD_PUPD_MASK, 0);

				sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R0_MASK, 0);
				sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC_DAT_R1_MASK, 0);
				sdr_set_field(MDSC2_DAT_PAD_1, MSDC2_DAT_PAD_PUPD_MASK, 0);

				sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R0_MASK, 0);
				sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC_CLK_R1_MASK, 0);
				sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC2_CLK_PUPD_MASK, 0);
...
void msdc_set_smt(struct msdc_host *host,int set_smt)
{
    switch(host->id){
        case 0:
			sdr_set_field(MSDC0_GPIO_CLK_BASE, GPIO_MSDC0_CLK_SMT_MASK, set_smt);
			sdr_set_field(MSDC0_GPIO_CMD_BASE, GPIO_MSDC0_CMD_SMT_MASK, set_smt);
			sdr_set_field(MDSC0_DAT_PAD_1, GPIO_MSDC0_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
			sdr_set_field(MDSC0_DAT_PAD_2, GPIO_MSDC0_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
            break;
        case 1:
            sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_SMT_MASK, set_smt);
            sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_SMT_MASK, set_smt);
			sdr_set_field(MDSC1_DAT_PAD_1, GPIO_MSDC1_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
            break;
        case 2:
			sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_SMT_MASK, set_smt);
			sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_SMT_MASK, set_smt);
			sdr_set_field(MDSC2_DAT_PAD_1, GPIO_MSDC2_DAT_SMT_MASK, set_smt != 0 ? 0x1111: 0);
			break;
		default:
			break;
	}
...
void msdc_set_driving(struct msdc_host *host,struct msdc_hw *hw,bool sd_18)
{
	switch(host->id){
		...
		case 1:
			if(sd_18){
				sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_DRVN, hw->clk_drv_sd_18);
				sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_DRVN, hw->cmd_drv_sd_18);
				sdr_set_field(MSDC1_GPIO_DAT_BASE, GPIO_MSDC1_DRVN, hw->dat_drv_sd_18);
			}
			else{
			sdr_set_field(MSDC1_GPIO_CLK_BASE, GPIO_MSDC1_DRVN, hw->clk_drv);
			sdr_set_field(MSDC1_GPIO_CMD_BASE, GPIO_MSDC1_DRVN, hw->cmd_drv);
			sdr_set_field(MSDC1_GPIO_DAT_BASE, GPIO_MSDC1_DRVN, hw->dat_drv);
			}
			break;
        case 2:
			if(sd_18){
				sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC1_DRVN, hw->clk_drv);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC1_DRVN, hw->cmd_drv);
				sdr_set_field(MSDC2_GPIO_DAT_BASE, GPIO_MSDC1_DRVN, hw->dat_drv);
			}
			else{
				sdr_set_field(MSDC2_GPIO_CLK_BASE, GPIO_MSDC1_DRVN, hw->clk_drv);
				sdr_set_field(MSDC2_GPIO_CMD_BASE, GPIO_MSDC1_DRVN, hw->cmd_drv);
...
#ifdef MTK_PMIC_MT6397
			msdc_ldo_power(on, MT65XX_POWER_LDO_VMC, VOL_3300, &g_msdc1_io);
			if (host->hw->flags & MSDC_SD_NEED_POWER) { //some board, like Yecon, need VMCH always power on, or cannot detect sd card
				msdc_ldo_power(1, MT65XX_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);
			} else
			{
				msdc_ldo_power(on, MT65XX_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);
			}
#else
...
#ifdef MTK_PMIC_MT6397
			msdc_ldo_power(on, MT65XX_POWER_LDO_VMC, VOL_1800, &g_msdc1_io);
#else
...
#if 0
// Now this method is not need for MT8127 Combo-eMMC
...
static int msdc_ops_switch_volt(struct mmc_host *mmc, struct mmc_ios *ios)
{
	...
	msdc_retry(sdc_is_busy(), retry, timeout,host->id);
        ...
        if ((sdr_read32(MSDC_PS) & ((1 << 24) | (0xF << 16))) == 0) {
			...
			/* 23Jan2014 chaotian.jing, in my opinion, pull down is better than pull none*/
