...
typedef struct
{
	SRC_CBUS_TX_STATE	 tx_state; //buf have data
...
extern bool fgCbusReqDdcReadCmd(bool fgEdid,unsigned char u1Seg,unsigned char u1Offset,unsigned char u1Len,unsigned char *ptData);
...
extern unsigned char fgCbusValue(void);
extern void mhl_set_share_path(unsigned char usb);
extern void mhl_set_share_iddig(unsigned char level);
extern void mhl_usb_share_init(void);
//#define MHL_CBUS_VERIFY
#endif
#endif
