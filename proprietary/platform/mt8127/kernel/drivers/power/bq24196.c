...
extern int ChargingOff; //Barkly, sysfs node for enable/disable charging

static void bq24196_shutdown(struct i2c_client *client)
{

    printk("[bq24196_shutdown] driver shutdown \n");
...
static int bq24196_suspend(struct device *dev)
{
	...
	bq24196_set_watchdog(0x0); //WDT disable
#endif
	return 0;
}
...
#define bq24196_suspend  NULL
#define bq24196_resume	  NULL
#define bq24196_shutdown NULL
#endif

static const struct dev_pm_ops bq24196_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(bq24196_suspend, bq24196_resume)
