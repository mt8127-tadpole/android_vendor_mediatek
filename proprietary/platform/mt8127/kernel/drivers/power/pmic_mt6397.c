...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    if(chip_version >= PMIC6397_E1_CID_CODE)
    {
        ...
        ret = pmic_config_interface(0x22A,0x18,0x7F,0); // [6:0]: VCA15_VOSEL_SLEEP;
...
void pmic_low_power_setting(void)
{
    ...
    ret = pmic_config_interface(0x206  , 0x0000 , 0x0060 ,0);
    ret = pmic_config_interface(0x402  , 0x0001 , 0x0001 ,0);

    if (chip_version > PMIC6397_E1_CID_CODE) {
        /* printk("@@@@@@@@0x128 chip_version=0x%x\n", chip_version); */
        ret = pmic_config_interface(0x128  , 0x0060 , 0x0060 ,0);
    }
    /* VTCXO control */
    if (chip_version > PMIC6397_E1_CID_CODE) {
