...
ret = pmic_config_interface(0x2,0xE,0xF,4); // [7:4]: RG_VCDT_HV_VTH; 9.5V OVP
#else
...
static int pmic_mt6323_probe(struct platform_device *dev)
{
    ...
    Disable_Unused_Power(); //Barkly 1/30/2015
