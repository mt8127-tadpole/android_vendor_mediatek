...
ifeq ($(MTK_PMIC_MT6397),yes)
    LOCAL_SRC_FILES += aud_drv/AudioPlatformDevice_6397.cpp \
                       aud_drv/AudioMachineDevice_6397.cpp
endif

ifneq ($(MTK_PMIC_MT6397),yes)
    LOCAL_SRC_FILES += aud_drv/AudioPlatformDevice_6323.cpp \
                       aud_drv/AudioMachineDevice_6323.cpp
endif 
...
ifneq (,$(filter yes, $(MTK_INTERNAL_HDMI_SUPPORT) $(MTK_INTERNAL_MHL_SUPPORT)))
    LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/kernel/drivers/hdmitx
    ifeq ($(MTK_INTERNAL_HDMI_SUPPORT),yes)
        LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/kernel/drivers/hdmi
    endif
    ifeq ($(MTK_INTERNAL_MHL_SUPPORT),yes)
        LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/kernel/drivers/mhltx
    endif

    LOCAL_SRC_FILES += aud_drv/AudioMTKHdmiStreamOut.cpp \
                       aud_drv/AudioMTKSpecificStreamManager.cpp \
                       aud_drv/AudioHdmiControl.cpp \
                       aud_drv/AudioHdmiControlFactory.cpp

    LOCAL_CFLAGS += -DUSE_SPECIFIC_STREAM_MANAGER
endif
...
LOCAL_C_INCLUDES:= \
    ...
    $(MTK_PATH_PLATFORM)/external/meta/Audio \
    $(MTK_PATH_SOURCE)/external/meta/common/inc \
    $(MTK_PATH_SOURCE)/external/fft

LOCAL_CFLAGS += -DMTK_AUDIO

LOCAL_SRC_FILES = aud_drv/AudioCLI.cpp ../../external/meta/Audio/AudioMeta.cpp
