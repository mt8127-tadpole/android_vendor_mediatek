...
{    
    ...
    //VCDT_HV_VTH, 9.5V
    ret_val=pmic_config_interface(CHR_CON1, 0x0E, PMIC_RG_VCDT_HV_VTH_MASK, PMIC_RG_VCDT_HV_VTH_SHIFT);
#else
    //VCDT_HV_VTH, 7V
...
U32 pmic_init (void)
{
...
#if 0 //VPROC 1.25;
    //set VPROC to 1.25V
    pmic_config_interface(VPROC_CON9, 0x58, PMIC_VPROC_VOSEL_MASK, PMIC_VPROC_VOSEL_SHIFT);
    pmic_config_interface(VPROC_CON10, 0x58, PMIC_VPROC_VOSEL_ON_MASK, PMIC_VPROC_VOSEL_ON_SHIFT);
    //get settings
    pmic_read_interface(VPROC_CON12,&reg_val,PMIC_NI_VPROC_VOSEL_MASK,PMIC_NI_VPROC_VOSEL_SHIFT);
    print("[VPROC 1.25]VPROC setting 0x%x, should be 0x58\n", reg_val);
#endif
    ...
    //get settings
    pmic_read_interface(VPROC_CON12,&reg_val,PMIC_NI_VPROC_VOSEL_MASK,PMIC_NI_VPROC_VOSEL_SHIFT);
    print("[VPROC 1.15]VPROC setting 0x%x, should be 0x48\n", reg_val);
#endif
