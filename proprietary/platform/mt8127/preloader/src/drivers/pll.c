...
#define pllc1_vco_div_sel_n2            (0x00000000 << 13)
    ...
    //DDR1333
    #ifdef DDRPHY_3PLL_MODE
        #ifdef DA_MEMPLL_REFCLK_52M
            #define pllc1_mempll_n_info_30_24_n4    (0x0000004b << 25)
            #define pllc1_mempll_n_info_23_0_n4     (0x0012a32a << 1)
        #else
            #define pllc1_mempll_n_info_30_24_n4    (0x00000050 << 25)
...
#ifdef DA_MEMPLL_REFCLK_52M 
#define pllc1_mempll_div_6_0            (0x00000029 << 25)
#else
...
#ifdef DA_MEMPLL_REFCLK_52M
#define mempll2_br                      (0x00000000 << 26)
#define mempll2_bp                      (0x00000000 << 27)
#else
...
#define mempll2_bp                      (0x00000001 << 27)
   ...
   #ifdef DDRPHY_3PLL_MODE
       #ifdef DA_MEMPLL_REFCLK_52M
       #define mempll2_fbdiv_6_0    (0x00000007 << 2)
       #else
       #define mempll2_fbdiv_6_0    (0x0000000d << 2)
       #endif
   #else
        #ifdef DA_MEMPLL_REFCLK_52M
            #define mempll2_fbdiv_6_0    (0x0000001c << 2)
        #else
            //to-do
            //#define mempll2_fbdiv_6_0    (0x0000000d << 2)
        #endif
...
#ifdef DA_MEMPLL_REFCLK_52M
#define mempll2_posdiv_1_0              (0x00000001 << 30)
#else
...
#define mempll3_prediv_1_0               mempll2_prediv_1_0
#define mempll3_vco_div_sel              mempll2_vco_div_sel
#define mempll3_br                       mempll2_br
#define mempll3_bp                       mempll2_bp
#define mempll3_m4pdiv_1_0               mempll2_m4pdiv_1_0
#define mempll3_fbdiv_6_0                mempll2_fbdiv_6_0
#define mempll3_fb_mck_sel               mempll2_fb_mck_sel
#define mempll3_fbksel_1_0               mempll2_fbksel_1_0
#define mempll3_posdiv_1_0               mempll2_posdiv_1_0
#define mempll3_ref_dl_4_0               mempll2_ref_dl_4_0
#define mempll3_fb_dl_4_0                mempll2_fb_dl_4_0
#define mempll3_en                       mempll2_en

#define mempll4_prediv_1_0               mempll2_prediv_1_0
#define mempll4_vco_div_sel              mempll2_vco_div_sel
#define mempll4_br                       mempll2_br
#define mempll4_bp                       mempll2_bp
#define mempll4_m4pdiv_1_0               mempll2_m4pdiv_1_0
#define mempll4_fbdiv_6_0                mempll2_fbdiv_6_0
#define mempll4_fb_mck_sel               mempll2_fb_mck_sel
#define mempll4_fbksel_1_0               mempll2_fbksel_1_0
#define mempll4_posdiv_1_0               mempll2_posdiv_1_0
#define mempll4_ref_dl_4_0               mempll2_ref_dl_4_0
#define mempll4_fb_dl_4_0                mempll2_fb_dl_4_0
#define mempll4_en                       mempll2_en
...
void mt_mempll_init(void)
{
    ...
    *((UINT32P)(DDRPHY_BASE + 0x007c)) |= 0x00000001;
    ...
    #ifdef DRAMC_ASYNC
        #ifdef DDRPHY_3PLL_MODE
            *((UINT32P)(DDRPHY_BASE + (0x0190 <<2))) = 0x00000020; //3PLL async mode, OK
        #else
    ...
    *((UINT32P)(DDRPHY_BASE + (0x0180 <<2))) = pllc1_prediv_1_0_n1  | pllc1_vco_div_sel_n2 | pllc1_postdiv_1_0_n5  | 0x044c0000;
    ...
    *((UINT32P)(DDRPHY_BASE + (0x0188 <<2))) = mempll4_ref_dl_4_0 | mempll4_fb_dl_4_0 | 0x00008c00;
    ...
    *((UINT32P)(DDRPHY_BASE + (0x0189 <<2))) = (*((UINT32P)(DDRPHY_BASE + (0x0189 <<2))))^0x01;

    #ifdef DRAMC_ASYNC
        #ifdef DDRPHY_3PLL_MODE
            *((UINT32P)(DDRPHY_BASE + (0x0190 <<2))) = 0x00000020 | r_dmpll2_clk_en; //3PLL async mode
        #else
    ...
    *((UINT32P)(DDRPHY_BASE + (0x0181 <<2))) |= pllc1_mempll_div_6_0 | pllc1_mempll_reserve_2 | (pllc1_mempll_bias_en | pllc1_mempll_bias_lpf_en);
    ...
    /*default val: [0x0180] = 0x044c8000*/
    *((UINT32P)(DDRPHY_BASE + (0x0180 <<2))) = pllc1_prediv_1_0_n1  | pllc1_vco_div_sel_n2 | pllc1_postdiv_1_0_n5  | (pllc1_mempll_en) | 0x044c0000;
    ...
    *((UINT32P)(DDRPHY_BASE + (0x018a <<2))) = 0x18000000;
    ...
    // pllc1_mempll_sdm_prd_1 ===> need check with mempll designer 
    /*default val: [0x0188] = 0x00008c00*/
    *((UINT32P)(DDRPHY_BASE + (0x0188 <<2))) = mempll4_ref_dl_4_0 | mempll4_fb_dl_4_0 | ( pllc1_mempll_sdm_prd_1) | 0x00008c00;
    gpt_busy_wait_us(2);
...
void mt_mempll_init(int type, int pll_mode)
{
    ...
    ******************************************************************************************/
    ...
    {	
        ...
        if(pll_mode==2 || pll_mode==3)
            mempll2_fbdiv_6_0 = (0x00000007 << 2);
        else
            mempll2_fbdiv_6_0 = (0x0000002a << 2);
    }
    else if(type == 800)
    ...
    ************************************************/
    ...
    while (1)
    {
        ...
        ************************************************/
        ...
        //gpt_busy_wait_us(60); // wait for jitter meter complete (depend on Fref)
        ...
        if (!pll3_done) 
        {
            while (!(DRV_Reg32(0x1000F32C)&0x00000002))
            {
                ...
                if (jmeter_wait_count>MEMPLL_JMETER_WAIT_TIMEOUT)
                {
                    print("[ERROR] PLL3 Jeter Meter Count Timeout > %d us!!\n", MEMPLL_JMETER_WAIT_TIME_BASE*MEMPLL_JMETER_WAIT_TIMEOUT);
                    break;
                }
            }
        }
        ...
        if (!pll4_done) 
        {
            while (!(DRV_Reg32(0x1000F32C)&0x00000004))
            {
                ...
                if (jmeter_wait_count>MEMPLL_JMETER_WAIT_TIMEOUT)
                {
                    print("[ERROR] PLL4 Jeter Meter Count Timeout > %d us!!\n", MEMPLL_JMETER_WAIT_TIME_BASE*MEMPLL_JMETER_WAIT_TIMEOUT);
                    break;
                }
            }
        }
...
#define ENABLE_AUDPLL   1
#define ENABLE_TVDPLL   1
#define ENABLE_LVDSPLL  1
#define ENABLE_DISP     1
...
void mt_pll_init(void)
{
    ...
    DRV_WriteReg32(AP_PLL_CON3, 0x01F80000); // set CHG bypass delay
...
#if ENABLE_UNIVPLL
    DRV_WriteReg32(UNIVPLL_CON1, 0x800C0000);
#endif
    ...
    **************/
    ...
    #endif
#else
	mt_mempll_init(DDR_MEMPLL, DDR_PLL_MODE);
#endif
    ...
    *************/
    ...
    DRV_WriteReg32(CLK_CFG_4, 0x01010100); // scp = 66Mhz, pmic = 26Mhz

    DRV_WriteReg32(CLK_CFG_5, 0x01010106); // MT8127

    DRV_WriteReg32(CLK_CFG_6, 0x00000100); // MT8127
