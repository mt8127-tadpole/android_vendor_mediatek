...
LID_BIT VER_LID(AP_CFG_RDEB_FILE_SENSOR_DATA_LID)
SENSOR_DATA_CFG_Struct *CFG_FILE_SENSOR_DATA_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_RDEB_FILE_SN_DATA_LID)
SN_CFG_Struct *CFG_FILE_SN_REC_TOTAL
{
