...
#include "CFG_SensorData_Default.h"
#include "CFG_SNData_File.h"
#include "CFG_SNData_Default.h"
...
extern "C"
{
	...
	{"/data/nvram/APCFG/APRDEB/Sensor_Data",  VER(AP_CFG_RDEB_FILE_SENSOR_DATA_LID),    CFG_FILE_SENSOR_DATA_REC_SIZE,   CFG_FILE_SENSOR_DATA_REC_TOTAL,                SIGNLE_DEFUALT_REC,   (char *)&SensorDataCfgDefault, DataReset , NULL
        },
	{"/data/nvram/APCFG/APRDEB/SN",  VER(AP_CFG_RDEB_FILE_SN_DATA_LID),       CFG_FILE_SN_REC_SIZE,            CFG_FILE_SN_REC_TOTAL,                      SIGNLE_DEFUALT_REC,                                 (char *)&SNCfgDefault, DataReset , NULL
        },
	{
            "/data/nvram/APCFG/APRDCL/Audio_ver1_2_Vol_custom",       VER(AP_CFG_RDCL_FILE_AUDIO_VER1_2_VOLUME_CUSTOM_LID),         CFG_FILE_AUDIO_VER1_VOLUME_CUSTOM_REC_SIZE,
            CFG_FILE_AUDIO_VER1_VOLUME_CUSTOM_REC_TOTAL,           SIGNLE_DEFUALT_REC,                (char *)&audio_ver1_2_custom_default, DataReset , NULL
        },
	{
            "/data/nvram/APCFG/APRDCL/Audio_CompFlt",       VER(AP_CFG_RDCL_FILE_AUDIO_COMPFLT_AB_LID),         CFG_FILE_AUDIO_COMPFLT_REC_SIZE,
            CFG_FILE_AUDIO_COMPFLT_REC_TOTAL,                   SIGNLE_DEFUALT_REC,                (char *)&audio_custom_default_ab, DataReset , NULL
        },
    };
