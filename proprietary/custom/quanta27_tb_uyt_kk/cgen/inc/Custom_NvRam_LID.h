...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_RDEB_FILE_SENSOR_DATA_LID,
    AP_CFG_RDEB_FILE_SN_DATA_LID,
    AP_CFG_RDCL_FILE_AUDIO_VER1_2_VOLUME_CUSTOM_LID, //for HW A and B SPEAK
    AP_CFG_RDCL_FILE_AUDIO_COMPFLT_AB_LID,	//for HW A and B EQ
...
/* Sensor data */
#define AP_CFG_RDEB_FILE_SENSOR_DATA_LID_VERNO	"000"
/* SN data */
#define AP_CFG_RDEB_FILE_SN_DATA_LID_VERNO		"000"
/* Audio HW A and B volume table */
#define AP_CFG_RDCL_FILE_AUDIO_VER1_2_VOLUME_CUSTOM_LID_VERNO  "001"
/* Audio EQ for HW A and B*/
#define AP_CFG_RDCL_FILE_AUDIO_COMPFLT_AB_LID_VERNO	"001"
