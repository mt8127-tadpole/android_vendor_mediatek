...
//billy +++ for HW differ
AUDIO_VER1_CUSTOM_VOLUME_STRUCT audio_ver1_2_custom_default = {
    VER1_2_AUD_VOLUME_RING, //ring gain
    VER1_AUD_VOLUME_SIP,
    VER1_AUD_VOLUME_MIC,
    VER1_AUD_VOLUME_FM,
    VER1_AUD_VOLUME_SPH,
    VER1_AUD_VOLUME_SPH, // sph2 now use the same
    VER1_AUD_VOLUME_SID,
    VER1_2_AUD_VOLUME_MEDIA, //media gain
    VER1_AUD_VOLUME_MATV,
    VER1_AUD_NORMAL_VOLUME_DEFAULT,
    VER1_AUD_HEADSER_VOLUME_DEFAULT,
    VER1_AUD_SPEAKER_VOLUME_DEFAULT,
...
{
    BES_LOUDNESS_HCF_HSF_COEFF_L,
	BES_LOUDNESS_HCF_BPF_COEFF_L,
	BES_LOUDNESS_HCF_LPF_COEFF_L,
	BES_LOUDNESS_HCF_HSF_COEFF_R,
	BES_LOUDNESS_HCF_BPF_COEFF_R,
	BES_LOUDNESS_HCF_LPF_COEFF_R,
...
{
    BES_LOUDNESS_HSF_COEFF_MUSICDRC_L,
	BES_LOUDNESS_BPF_COEFF_MUSICDRC_L,
	BES_LOUDNESS_LPF_COEFF_MUSICDRC_L,
	BES_LOUDNESS_HSF_COEFF_MUSICDRC_R,
	BES_LOUDNESS_BPF_COEFF_MUSICDRC_R,
	BES_LOUDNESS_LPF_COEFF_MUSICDRC_R,
...
{
    BES_LOUDNESS_HSF_COEFF_RINGTONEDRC_L,
	BES_LOUDNESS_BPF_COEFF_RINGTONEDRC_L,
	BES_LOUDNESS_LPF_COEFF_RINGTONEDRC_L,
	BES_LOUDNESS_HSF_COEFF_RINGTONEDRC_R,
	BES_LOUDNESS_BPF_COEFF_RINGTONEDRC_R,
	BES_LOUDNESS_LPF_COEFF_RINGTONEDRC_R,
	BES_LOUDNESS_WS_GAIN_MAX_RINGTONEDRC,
	BES_LOUDNESS_WS_GAIN_MIN_RINGTONEDRC,
	BES_LOUDNESS_FILTER_FIRST_RINGTONEDRC,
	
	BES_LOUDNESS_SEP_LR_FILTER_RINGTONEDRC,
	BES_LOUDNESS_NUM_BANDS_RINGTONEDRC,
	BES_LOUDNESS_FLT_BANK_ORDER_RINGTONEDRC,
	BES_LOUDNESS_CROSSOVER_FREQ_RINGTONEDRC,

    BES_LOUDNESS_GAIN_MAP_IN_RINGTONEDRC,
    BES_LOUDNESS_GAIN_MAP_OUT_RINGTONEDRC,
    BES_LOUDNESS_SB_GAIN_RINGTONEDRC,
    BES_LOUDNESS_SB_MODE_RINGTONEDRC,
    BES_LOUDNESS_DRC_DELAY_RINGTONEDRC,
    BES_LOUDNESS_ATT_TIME_RINGTONEDRC,
    BES_LOUDNESS_REL_TIME_RINGTONEDRC,    
	BES_LOUDNESS_HYST_TH_RINGTONEDRC,
	BES_LOUDNESS_LIM_TH_RINGTONEDRC,
	BES_LOUDNESS_LIM_GN_RINGTONEDRC,
	BES_LOUDNESS_LIM_CONST_RINGTONEDRC,
	BES_LOUDNESS_LIM_DELAY_RINGTONEDRC,
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_custom_default_ab =
{
    	BES_LOUDNESS_HSF_COEFF_AB,
        BES_LOUDNESS_BPF_COEFF_AB,
        BES_LOUDNESS_LPF_COEFF_AB,
        BES_LOUDNESS_WS_GAIN_MAX_AB,
        BES_LOUDNESS_WS_GAIN_MIN_AB,
        BES_LOUDNESS_FILTER_FIRST_AB,
        BES_LOUDNESS_ATT_TIME_AB,
        BES_LOUDNESS_REL_TIME_AB,
        BES_LOUDNESS_GAIN_MAP_IN_AB,
        BES_LOUDNESS_GAIN_MAP_OUT_AB,
};
