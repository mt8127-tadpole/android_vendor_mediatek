...
public class EthernetStateTracker implements NetworkStateTracker {
    ...
    public void startMonitoring(Context context, Handler target) {
        ...
        ///M add by mtk94127,  setup pppoe service @{
        PppoeService  pppService = new PppoeService();
        ServiceManager.addService("pppoe", pppService);
        pppService.startMonitoring(context, target);
        ///M @}
