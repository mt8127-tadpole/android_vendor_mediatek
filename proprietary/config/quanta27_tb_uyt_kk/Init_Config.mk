...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      ...
                      $(MTK_ROOT_CONFIG_OUT)/PDC.ini:data/misc/PDC.ini
...
ifeq ($(QCI_MODEL_VARIANT), $(filter $(QCI_MODEL_VARIANT), LEAPFROG LEAPFROG_WAL LEAPFROG2 LEAPFROG2_WAL))
	FeatureFile_WifiDirect := android.hardware.wifi.direct.xml.__enable
else
	FeatureFile_WifiDirect := android.hardware.wifi.direct.xml.__disable
endif
$(info FeatureFile_WifiDirect=$(FeatureFile_WifiDirect))
PRODUCT_COPY_FILES += \
	$(MTK_ROOT_CONFIG_OUT)/$(FeatureFile_WifiDirect):system/etc/permissions/android.hardware.wifi.direct.xml
...
##### INSTALL SensorsCalib.sh ######

PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/firmware/SensorsCalib.sh:system/bin/SensorsCalib.sh
